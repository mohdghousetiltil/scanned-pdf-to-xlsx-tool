...
if __name__ == "__main__":
    ocr_pdf(
        input_pdf="pdfs/PODS-1-3.pdf",
        json_output="ocr1-3.json",
        pdf_output="PODS.pdf",
        scale=3,
        dpi_for_pdf=300,
...
#     reco_arch="parseq",
#     pretrained=True,
#     det_bs=8,        # if GPU can handle, else keep 4
#     reco_bs=512,     # if GPU can handle, else keep 256
#     assume_straight_pages=True,
#     export_as_straight_boxes=True,
#     preserve_aspect_ratio=True,
# ).to(device)
...
# ocr_pdf(
#     input_pdf="pdfs/PODS-1-3.pdf",
#     json_output="jsons/ocr1-3.json",
#     pdf_output="pdfs/PODS_1-3.pdf",
#     scale=2,            # was 3 -> faster
#     dpi_for_pdf=200,    # was 300 -> smaller, a bit faster
#     use_preprocessing=False,  # or True but only for OCR, not for PDF image
# )
